...
class Calculator:
    def __init__(self,master):
        ...
        Button(width=11,height=4,text='=',relief='flat',bg='#999999',command=lambda:self.solve()).place(x=270,y=350)
        Button(width=11,height=4,text='C',relief='flat',bg='#ff9028',command=lambda:self.clear()).place(x=0,y=350)
